(() => {
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".swiper-partners")) new core(".swiper-partners", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
            ...
            if (document.querySelector(".swiper-documents")) new core(".swiper-documents", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
        ...
        function updateProgressbar() {
            progressSteps.forEach(((progressStep, idx) => {
                if (idx < formStepsNum + 1) progressStep.classList.add("progress-step-active"); else progressStep.classList.remove("progress-step-active");
            }));
            const progressActive = document.querySelectorAll(".progress-step-active");
            progress.style.width = (progressActive.length - 1) / (progressSteps.length - 1) * 55 + "%";
        }
        window["FLS"] = true;
        isWebp();
        menuInit();
